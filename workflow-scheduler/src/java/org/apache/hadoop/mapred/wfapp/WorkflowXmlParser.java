...
public class WorkflowXmlParser {
	...
	private static final String HIGH_P = "high";
	private static final String NORMAL_P = "normal";
	private static final String LOW_P = "low";
	private static final String LINGER_P = "linger";
    ...
    public WorkflowXmlParser(Schema schema,
    ...
    /**
     * Parse and validate xml to {@link WorkflowApp}
     *
     * @param reader
     * @return WorkflowApp
     * @throws WorkflowException
     */
    public WorkflowApp validateAndParse(Reader reader) throws WorkflowException {
        try {
            ...
            ParameterVerifier.verifyParameters(wfDefElement);
            WorkflowApp app = parse(strDef, wfDefElement);
            ...
            // here abandon : && Services.get().getConf().getBoolean(VALIDATE_FORK_JOIN, true)
    ...
    /**
     * Validate whether fork/join are in pair or not
     * @param app WorkflowApp
     * @throws WorkflowException
     */
    private void validateForkJoin(WorkflowApp app) throws WorkflowException {
     ...
     * This should be called from validateForkJoin(WorkflowApp app).  It assumes that visitedOkNodes and visitedJoinNodes are
     ...
     * @throws WorkflowException
     */
    private void validateForkJoin(NodeDef node, WorkflowApp app, Deque<String> forkNodes, Deque<String> joinNodes,
    ...
    private WorkflowApp parse(String strDef, Element root) throws WorkflowException {
     ...
     * @throws WorkflowException
     */
    private void validate(WorkflowApp app, NodeDef node, Map<String, VisitStatus> traversed) throws WorkflowException {
        if (node instanceof StartNodeDef) {
...
//                }
    ...
    /**
     * set the charactertics of workflow scheduler, deadline, priority, trigger
     * @param ns
     * @param global
     * @param app
     * @throws WorkflowException
