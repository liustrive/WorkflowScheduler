...
public abstract class ParameterVerifier 
{
     ...
     */
    public static void verifyParameters( Element rootElement) throws IOException {
        ...
        if (supportsParameters(rootElement.getNamespaceURI())) {
            ...
            if (params != null) {
                ...
                while (it.hasNext()) {
                    ...
                    if (name != null) {
                        if (name.isEmpty()) {
                            throw new IOException("parameter verify exception: name is empty");
                        }
...
//                        }
                ...
                if (numMissing > 0) {
                    ...
                    throw new IOException( "missing parameters: "+missingParameters.toString());
                }
            } else {
                // Log a warning when the <parameters> section is missing
//                LOG.INFO("The application does not define formal parameters in its XML "
//                        + "definition");
            }
        }
    }
