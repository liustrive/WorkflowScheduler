...
class WorkflowSchedulerQueue {
   ...
   */
  WorkflowSchedulerQueue.SlotsUsage mapSlots;
  WorkflowSchedulerQueue.SlotsUsage reduceSlots;
  ...
  synchronized void initializeQueue(WorkflowSchedulerQueue other) {
  ...
  synchronized void initializeQueue(WorkflowSchedulerConf conf) {
