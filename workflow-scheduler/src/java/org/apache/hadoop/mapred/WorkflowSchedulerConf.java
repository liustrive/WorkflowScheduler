 ...
 */
class WorkflowSchedulerConf {
  
  /** Default file name from which the resource manager configuration is read. */ 
  public static final String SCHEDULER_CONF_FILE = "workflow-scheduler.xml";
   ...
   */
  public WorkflowSchedulerConf(Path configFile) {
    rmConf = new Configuration(false);
