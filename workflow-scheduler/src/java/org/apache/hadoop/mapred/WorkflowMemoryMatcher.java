...
class WorkflowMemoryMatcher {

  private static final Log LOG = LogFactory.getLog(WorkflowMemoryMatcher.class);
  private WorkflowTaskScheduler scheduler;

  public WorkflowMemoryMatcher(WorkflowTaskScheduler WorkflowTaskScheduler) {
    this.scheduler = WorkflowTaskScheduler;
  }
