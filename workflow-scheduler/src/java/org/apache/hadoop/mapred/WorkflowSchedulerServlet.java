...
public class WorkflowSchedulerServlet extends HttpServlet {
  ...
  private transient WorkflowTaskScheduler scheduler;
  ...
  public void init() throws ServletException {
    ...
    this.scheduler = (WorkflowTaskScheduler) servletContext
  ...
  private void showQueues(PrintWriter out) 
    ...
    synchronized(scheduler) {
      ...
      for (WorkflowSchedulerQueue queue : scheduler.getQueueInfoMap().values()) {
